...
/**
 *
 *  用于编码/解码 hashgard-sdk识别的StdTx交易模型
...
class TxSerializer {
    ...
    static encode(object) {
        ...
        let fee = object.fee;
        let StdFee = root.hashgard.StdFee;
        let feeMsg = StdFee.create(fee);

        let StdSignature = root.hashgard.StdSignature;
        let signature;
        ...
        let txPreBuf = Buffer.from(amino.GetRegisterInfo(config.hashgard.tx.stdTx.prefix).prefix);
