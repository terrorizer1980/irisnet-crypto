...
class HashgardKeypair {

    static getPrivateKeyFromSecret(mnemonicS) {
        let seed = Bip39.mnemonicToSeed(mnemonicS);
        let master = Hd.ComputeMastersFromSeed(seed);
        let derivedPriv = Hd.DerivePrivateKeyForPath(master.secret, master.chainCode, Config.hashgard.bip39Path);
        return derivedPriv;
    }
    ...
    static create(language) {
        ...
        pubKey = Amino.MarshalBinary(Config.hashgard.amino.pubKey, pubKey);
    ...
    static isValidAddress(address) {
        let prefix = Config.hashgard.bech32.accAddr;
...
module.exports = HashgardKeypair;