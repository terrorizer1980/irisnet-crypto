...
const MsgDelegate = Root.hashgard.MsgDelegate;
const MsgUndelegate = Root.hashgard.MsgUndelegate;
const MsgBeginRedelegate = Root.hashgard.MsgBeginRedelegate;

MsgDelegate.prototype.type = Config.hashgard.tx.delegate.prefix;
...
MsgUndelegate.prototype.type = Config.hashgard.tx.undelegate.prefix;
...
MsgBeginRedelegate.prototype.type = Config.hashgard.tx.beginRedelegate.prefix;
MsgBeginRedelegate.prototype.GetSignBytes = function () {
    let msg = {
        delegator_address: BECH32.encode(Config.hashgard.bech32.accAddr, this.DelegatorAddress),
        validator_src_address: BECH32.encode(Config.hashgard.bech32.valAddr, this.ValidatorSrcAddress),
        validator_dst_address: BECH32.encode(Config.hashgard.bech32.valAddr, this.ValidatorDstAddress),
        amount: this.Amount
    };
    let sortMsg = Utils.sortObjectKeys(msg);
    return Amino.MarshalJSON(this.type, sortMsg)
...
MsgBeginRedelegate.prototype.GetDisplayContent = function () {
    let delegatorAddress = BECH32.encode(Config.hashgard.bech32.accAddr, this.DelegatorAddress);
    let validatorSrcAddress = BECH32.encode(Config.hashgard.bech32.valAddr, this.ValidatorSrcAddress);
    let validatorDstAddress = BECH32.encode(Config.hashgard.bech32.valAddr, this.ValidatorDstAddress);
